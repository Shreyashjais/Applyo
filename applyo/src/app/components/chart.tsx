...
const TOOLTIP_CONFIG: Record<string, { label: string; color: string }> = {
...
interface PayloadEntry {
  dataKey: keyof typeof TOOLTIP_CONFIG;
  value: number | string;
}
    ...
    <div className="h-80 w-full">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
          ...
          <Line type="monotone" dataKey="highest" stroke="#5B21B6" strokeWidth={2} dot={{ r: 4 }} />
          <Line type="monotone" dataKey="avg" stroke="#9D7EDB" strokeWidth={2} dot={{ r: 4 }} />
          <Line type="monotone" dataKey="median" stroke="#C4B5FD" strokeWidth={2} dot={{ r: 4 }} />
        </LineChart>
      </ResponsiveContainer>
