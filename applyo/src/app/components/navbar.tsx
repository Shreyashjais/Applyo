...
import { FaFacebookF, FaGithub, FaInstagram, FaLinkedinIn, FaSearch, FaTwitter } from "react-icons/fa";
import { IoReorderThreeOutline } from "react-icons/io5";
import { RxCross1 } from "react-icons/rx";

interface NavbarProps {
  isMenuUp: boolean;
  setIsMenuUp: React.Dispatch<React.SetStateAction<boolean>>;
}

const Navbar: React.FC<NavbarProps> = ({ isMenuUp, setIsMenuUp }) => {
  return (
      ...
      <div className="flex justify-between items-center px-6 py-4 border border-gray-300 bg-[#FFFFFF]">
        <div className="flex items-center lg:ml-12">
          ...
          <div className="hidden xl:flex gap-4 text-[#182230] lg:ml-8 font-medium">
            <div className="cursor-pointer hover:text-blue-600 transition bg-gray-100 px-3 py-2 rounded-md border-0">Home</div>
            <div className="cursor-pointer hover:text-blue-600 transition px-3 py-2">Dashboard</div>
            <div className="cursor-pointer hover:text-blue-600 transition px-3 py-2">Daily Challenge</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div
            ...
            onClick={() => setIsMenuUp(!isMenuUp)}
          >
            {isMenuUp ? <div> </div> : <IoReorderThreeOutline />}
          </div>
        </div>
      </div>
          ...
          <div className="fixed top-0 left-0 w-80 h-full bg-white z-50 shadow-md gap-6 transform transition-transform duration-300">
            <div className="gap-4 flex flex-col border-b-2 pb-4 border-gray-200">
              <div className="flex justify-between p-6">
                <Image src="/assets/logo.png" alt="Applyo" width={80} height={50} />
                <button onClick={() => setIsMenuUp(false)}>
            ...
            <div className="flex flex-col mt-6 mx-3 gap-3">
              ...
              <button
                onClick={() => setIsMenuUp(false)}
                className="px-8 py-2 border-2 text-sm cursor-pointer font-semibold border-[#E6E8EC] rounded-lg text-gray-700 transition"
              >
                Login
              </button>
            </div>
            ...
            <div className="flex absolute border-t-2 w-full border-gray-200 bottom-0 pt-3 flex-col justify-center items-center">
              <div className="flex justify-center items-center gap-6 mt-4 md:mt-0">
                <a href="#" className="hover:text-gray-700 text-gray-400"><FaLinkedinIn size={20} /></a>
                <a href="#" className="text-gray-400 hover:text-gray-700"><FaInstagram size={20} /></a>
                <a href="#" className="text-gray-400 hover:text-gray-700"><FaFacebookF size={20} /></a>
